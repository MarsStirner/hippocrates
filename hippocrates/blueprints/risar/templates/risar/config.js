...
.constant('Config', {
    url: {
        ...
        print_gyn_checkup: '{{ url_for('.printing_gyn_checkup') }}',
        print_pc_checkup: '{{ url_for('.printing_pc_checkup') }}',
        ...
        api_update_set_date: '{{ url_for('.api_0_update_set_date', event_id=-99).replace('-99', '{0}') }}',
        ...
        api_maternal_death_stats: '{{ url_for('.api_0_maternal_death_stats') }}',
        api_perinatal_death_stats: '{{ url_for('.api_0_perinatal_death_stats') }}',
        ...
        api_chart_regional_risks: '{{ url_for('.api_0_chart_regional_risks', event_id=-90) | replace("-90", "{0}") }}',
