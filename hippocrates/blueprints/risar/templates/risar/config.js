...
.constant('Config', {
    url: {
        gyn: {
            ...
            chart:'{{ url_for('.api_1_gyn_chart') }}',
            mini_chart: '{{ url_for('.api_0_mini_chart') }}',
            header: '{{ url_for('.api_0_chart_header') }}',
            delete: '{{ url_for('.api_0_chart_delete') }}',
            close: '{{ url_for('.api_0_chart_close') }}{0}',
        },
        ...
        api_anamnesis: '{{ url_for('.api_1_pregnancy_chart') }}{0}/anamnesis',
        api_anamnesis_mother: '{{ url_for('.api_1_pregnancy_chart') }}{0}/mother',
        api_anamnesis_father: '{{ url_for('.api_1_pregnancy_chart') }}{0}/father',
        ...
        api_epicrisis:'{{ url_for('.api_1_pregnancy_chart')}}{0}/epicrisis',
        ...
        api_checkup_puerpera_list: '{{ url_for('.api_0_checkup_puerpera_list') }}',
        api_checkup_puerpera_get: '{{ url_for('.api_0_checkup_puerpera_get') }}{0}',
        api_checkup_puerpera_new: '{{ url_for('.api_0_checkup_puerpera_new') }}{0}',
        api_checkup_puerpera_save: '{{ url_for('.api_0_checkup_puerpera') }}{0}',
