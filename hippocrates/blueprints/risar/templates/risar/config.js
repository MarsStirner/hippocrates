...
.constant('Config', {
    url: {
        gyn: {
            ...
            chart:'{{ url_for('.api_0_gyn_chart', event_id=-99).replace('-99', {}) }}',
            mini_chart: '{{ url_for('.api_0_gyn_mini_chart', event_id=-99).replace('-99', {}) }}',
            header: '{{ url_for('.api_0_gyn_chart_header', event_id=-99).replace('-99', {}) }}',
            delete: '{{ url_for('.api_0_gyn_chart_delete', ticket_id=-99).replace('-99', {}) }}',
            close: '{{ url_for('.api_0_gyn_chart_close', event_id=-99).replace('-99', {}) }}',
            anamnesis: '{{ url_for('.api_0_gyn_anamnesis', event_id=-99).replace('-99', {}) }}',
            anamnesis_general: '{{ url_for('.api_0_gyn_anamnesis_general', event_id=-99).replace('-99', {}) }}',
        },
