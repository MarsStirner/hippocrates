...
def test_create_update_refbook():
    with make_login() as session:
        ...
        print u'edited refbook: {0}'.format(repr(edited_org).decode("unicode-escape"))
