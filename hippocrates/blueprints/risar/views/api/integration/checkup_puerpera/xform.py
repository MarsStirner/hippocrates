...
class CheckupPuerperaXForm(CheckupPuerperaSchema, PregnancyCheckupsXForm):
    ...
    def update_target_obj(self, data):
        ...
        self.set_pcard()
        self.target_obj = get_action_by_id(self.target_obj_id, self.parent_obj, puerpera_inspection_flat_code, True)
...
class CheckupPuerperaTicket25XForm(CheckupsTicket25XFormSchema, CheckupsTicket25XForm):

    def set_checkup_xform(self):
        self.checkup_xform = CheckupPuerperaXForm(self.version, self.new)
