...
gyn_checkup_simple_codes = [
    ...
    'bimanual_comments',
    'rectovaginal _cervix_uteri',
    'rectovaginal _cervix_consistency',
    'rectovaginal _uterus_body',
    'rectovaginal _body_of_womb_size',
    'rectovaginal _body_of_womb_enlarged',
    ...
    'rectal_rectum',
    'rectal _cervix_uteri',
    'rectal _cervix_consistency',
    'rectal _uterus_body',
    'rectal _body_of_womb_size',
    'rectal _body_of_womb_enlarged',
