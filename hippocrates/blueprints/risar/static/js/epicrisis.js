'use strict';
var EpicrisisCtrl = function ($timeout, $scope, $q, RefBookService, RisarApi, PrintingService, PrintingDialog, PropsDescriptor) {
    ...
    $scope.PropsDescriptor = PropsDescriptor;
