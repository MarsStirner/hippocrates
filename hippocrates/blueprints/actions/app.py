    ...
    return {
        'url': {
            'actions': {
                ...
                'action_new_lab': uf_placeholders('actions.api_action_new_direction_get', ['action_type_id', 'event_id']),
                ...
                'create_treatment_direction': url_for('actions.api_create_treatment_direction'),
                'create_diagnostic_direction': url_for('actions.api_create_diagnostic_direction'),
