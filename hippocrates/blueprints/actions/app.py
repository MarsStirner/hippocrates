    ...
    return {
        'url': {
            'actions': {
                ...
                'action_new_direction': uf_placeholders('actions.api_action_new_direction_get', ['action_type_id', 'event_id']),
                ...
                'create_directions': url_for('actions.api_create_directions'),
