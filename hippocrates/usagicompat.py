...
class HippoUsagiClient(TsukinoUsagiClient):
    def on_configuration(self, configuration):
        ...
        from hippocrates.blueprints.hospitalization.app import module as hospitalization_module
        ...
        app.register_blueprint(hospitalization_module, url_prefix='/hospitalization')
